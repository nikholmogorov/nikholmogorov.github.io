...
setInterval(function () {
  let carousel = document.querySelector('#carouselExampleControls_loft');
  let carouselInstance = bootstrap.Carousel.getInstance(carousel);
  carouselInstance.next();
}, 2000);

setInterval(function () {
  let carousel = document.querySelector('#carouselExampleControls_analytics');
  let carouselInstance = bootstrap.Carousel.getInstance(carousel);
  carouselInstance.next();
}, 2000);

setInterval(function () {
  let carousel = document.querySelector('#carouselExampleControls_starbucks');
  let carouselInstance = bootstrap.Carousel.getInstance(carousel);
  carouselInstance.next();
}, 2000);
...
setInterval(function () {
  let carousel = document.querySelector('#carouselExampleControls_organic');
  let carouselInstance = bootstrap.Carousel.getInstance(carousel);
  carouselInstance.next();
}, 2000);

setInterval(function () {
  let carousel = document.querySelector('#carouselExampleControls_rzd-med');
  let carouselInstance = bootstrap.Carousel.getInstance(carousel);
  carouselInstance.next();
}, 2000);

setInterval(function () {
  let carousel = document.querySelector('#carouselExampleControls_baza');
  let carouselInstance = bootstrap.Carousel.getInstance(carousel);
  carouselInstance.next();
}, 2000);
